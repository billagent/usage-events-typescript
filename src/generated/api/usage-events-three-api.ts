...
/**
 * UsageEventsThreeApi - axios parameter creator
 * @export
 */
export const UsageEventsThreeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
...
/**
 * UsageEventsThreeApi - functional programming interface
 * @export
 */
export const UsageEventsThreeApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = UsageEventsThreeApiAxiosParamCreator(configuration)
    return {
        /**
         * Matches usage events to contract terms and returns event price and matched term metadata.
         * @summary Process a usage event
        ...
        async usageTermMatcherServiceIntakeUsageEvent(body: V1IntakeUsageEventRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1IntakeUsageEventResponse>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['UsageEventsThreeApi.usageTermMatcherServiceIntakeUsageEvent']?.[localVarOperationServerIndex]?.url;
...
/**
 * UsageEventsThreeApi - factory interface
 * @export
 */
export const UsageEventsThreeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = UsageEventsThreeApiFp(configuration)
    return {
        /**
         * Matches usage events to contract terms and returns event price and matched term metadata.
         * @summary Process a usage event
...
/**
 * UsageEventsThreeApi - interface
 * @export
 * @interface UsageEventsThreeApi
 */
export interface UsageEventsThreeApiInterface {
    /**
     * Matches usage events to contract terms and returns event price and matched term metadata.
     * @summary Process a usage event
     * @param {V1IntakeUsageEventRequest} body 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof UsageEventsThreeApiInterface
     */
    usageTermMatcherServiceIntakeUsageEvent(body: V1IntakeUsageEventRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1IntakeUsageEventResponse>;
...
/**
 * UsageEventsThreeApi - object-oriented interface
 * @export
 * @class UsageEventsThreeApi
 * @extends {BaseAPI}
 */
export class UsageEventsThreeApi extends BaseAPI implements UsageEventsThreeApiInterface {
    /**
     * Matches usage events to contract terms and returns event price and matched term metadata.
     * @summary Process a usage event
     * @param {V1IntakeUsageEventRequest} body 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof UsageEventsThreeApi
     */
    public usageTermMatcherServiceIntakeUsageEvent(body: V1IntakeUsageEventRequest, options?: RawAxiosRequestConfig) {
        return UsageEventsThreeApiFp(this.configuration).usageTermMatcherServiceIntakeUsageEvent(body, options).then((request) => request(this.axios, this.basePath));
    }
}
